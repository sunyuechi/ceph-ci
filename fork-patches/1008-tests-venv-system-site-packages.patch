From 03bde057d2fd362f83bbe9f1d40a5a4a4d3186f4 Mon Sep 17 00:00:00 2001
From: Sun Yuechi <sunyuechi@iscas.ac.cn>
Date: Sun, 7 Jun 2026 02:05:34 +0800
Subject: [PATCH] test: optionally run test venvs with system site-packages
...
---
 src/script/run_tox.sh         | 4 ++++
 src/tools/setup-virtualenv.sh | 5 ++++-
 2 files changed, 8 insertions(+), 1 deletion(-)

diff --git a/src/script/run_tox.sh b/src/script/run_tox.sh
index f2f71a60f29..301e828a204 100755
...
+    if [ -n "${CEPH_PYTHON_SYSTEM_SITE:-}" ]; then
...
index 152e4859715..f4ad3782e53 100755
